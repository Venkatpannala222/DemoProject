...
async function EditFavAccountPreferences(){
  ...
  expect(kony.automation.widget.getWidgetProperty(["frmProfileManagement","settings","segAccounts[0,0]","lblAccountName"],"text")).toEqual("My Checking");
  appLog("Successfully Clicked on SAVE button");
}
...
async function VerifyAccountPreferences(){
 ...
 expect(kony.automation.widget.getWidgetProperty(["frmProfileManagement","settings","segAddresses[0]","btnEdit"], "text")).toEqual('');
 expect(kony.automation.widget.getWidgetProperty(["frmProfileManagement","settings","segAddresses[0]","lblMove"], "text")).toEqual("Move");
 expect(kony.automation.widget.getWidgetProperty(["frmProfileManagement","settings","segAddresses[0]","lblMarkAsFavouriteAccountCheckBoxIcon"], "text")).not.toBe('');
 expect(kony.automation.widget.getWidgetProperty(["frmProfileManagement","settings","segAddresses[0]","lblMoveUpIcon"], "text")).not.toBe('');
 expect(kony.automation.widget.getWidgetProperty(["frmProfileManagement","settings","segAddresses[0]","lblMoveUpIcon"], "text")).not.toBe('');
  }
