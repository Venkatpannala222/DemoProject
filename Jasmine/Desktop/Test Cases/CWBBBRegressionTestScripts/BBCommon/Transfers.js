...
async function VerifyTransferConfirmationscreen(){
  ...
  expect(kony.automation.widget.getWidgetProperty(["frmReview","lblValue"], "text")).toEqual("Apex Account test....8636");
  //kony.automation.flexcontainer.click(["frmeTransferSendMoney","customheadernew","flxAccounts"]);
  ...
  expect(kony.automation.widget.getWidgetProperty(["frmReview","lblToValue"], "text")).toEqual("Summit Savings Account....8962");
...
async function VerifyTransferSuccessScreenRightPanel(){
 ...
 expect(kony.automation.widget.getWidgetProperty(["frmConfirmTransfer","lblToValue"], "text")).not.toBe('');
  ...
  expect(kony.automation.widget.getWidgetProperty(["frmConfirmTransfer","lblFrequencyValue"], "text")).toEqual("Once");
   await kony.automation.playback.waitFor(["frmConfirmTransfer","lblStartDateKey"],15000);
  expect(kony.automation.widget.getWidgetProperty(["frmConfirmTransfer","lblStartDateKey"], "text")).toEqual("When"); 
