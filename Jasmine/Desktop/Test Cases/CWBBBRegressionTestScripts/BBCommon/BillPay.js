...
async function enterOneTimePaymentdetails()
{
  ...
  kony.automation.textbox.enterText(["frmBulkPayees","segmentBillpay[0]","txtAmount"],"1.71");
  await kony.automation.playback.wait(10000);
  await kony.automation.playback.waitFor(["frmBulkPayees","segmentBillpay[1]","txtAmount"],15000);
  kony.automation.textbox.enterText(["frmBulkPayees","segmentBillpay[1]","txtAmount"],"1.26");
  await kony.automation.playback.wait(10000);
  ...
  //kony.automation.calendar.selectDate(["frmBulkPayees","segmentBillpay[0]","calSendOn"], [8,18,2024]);
...
async function SelectDateRange_SheduledBillpay() {
  ...
  kony.automation.calendar.selectDate(["frmBillPaymentDue","payABill","calSendOn"], [11,11,2021]);
  ...
  kony.automation.calendar.selectDate(["frmBillPaymentDue","payABill","CalDeliverBy"], [11,21,2021]);
...
//added by Tapasya 
async function EnterOneTimePaymentdetails_Bulk(Payee)
{
  appLog("Intiated method to enter details for OneTime payment");
  await kony.automation.playback.wait(10000);
  ...
  kony.automation.textbox.enterText(["frmBulkPayees","segmentBillpay[1]","txtAmount"],"1.34");
  ...
  kony.automation.calendar.selectDate(["frmBulkPayees","segmentBillpay[1]","calSendOn"], [11,14,2021]);
  await kony.automation.playback.wait(10000);
  ...
  kony.automation.textbox.enterText(["frmBulkPayees","segmentBillpay[2]","txtAmount"],"1.46");
  await kony.automation.playback.wait(10000);
  ...
  //     kony.automation.calendar.selectDate(["frmBulkPayees","segmentBillpay[2]","calSendOn"], [11,14,2021]);
  await kony.automation.playback.wait(10000);
  if(Payee=== Payees)
  {
    appLog("Same Payees");
