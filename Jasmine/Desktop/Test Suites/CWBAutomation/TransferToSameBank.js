describe("TransferToSameBank", function() {
	...
	async function ClickOnNewTransfer_TransferAcknowledgemntScreen(){
	  ...
	  kony.automation.flexcontainer.click(["frmConfirmTransfer","btnAddAnotherAccount"]);
		...
		// :End User Injected Code Snippet {27e26450-5490-56d5-bdab-d31c8bb61bfd}
	...
	it("HalfYearlySheduledTransfer-DateRange", async function() {
	  ...
	  await SelectToAccount(Transfers.sameBankAccount.toAccount);
	  await EnterAmount(Transfers.sameBankAccount.amountValue);
	  await SelectFrequency("HalfYearly");
	  await SelectDateRange();
	  await EnterNoteValue("HalfYearlySheduleTranDateRange");
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	  await verifyAccountsLandingScreen();
	...
	//   kony.automation.flexcontainer.click(["frmFastTransfers","flxContainer4"]);
	//   kony.automation.listbox.selectItem(["frmFastTransfers","lbxFrequency"], "Half Yearly");
	//   kony.automation.calendar.selectDate(["frmFastTransfers","calSendOnNew"], [10,25,2021]);
	//   kony.automation.calendar.selectDate(["frmFastTransfers","calEndingOnNew"], [11,25,2021]);
	  
	//   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	//   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"SameBank-HalfYearlySheduledTransfer-DateRange");
	...
	it("HalfYearlySheduledTransfer-Occurences", async function() {
	  ...
	  await SelectFrequency("HalfYearly");
	  await SelectOccurences("2");
	  await EnterNoteValue("HalfYearly SheduleTranOccr");
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	 await verifyAccountsLandingScreen();
	...
	//   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	//   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"SameBank-Half Yearly SheduledTransfer-Occurences");
	...
	it("MonthlySheduledTransfer-Occurences", async function() {
	  ...
	  await SelectFrequency("Monthly");
	  await SelectOccurences("2");
	  await EnterNoteValue("MonthlySheduleTrnsfrOccr");
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	  await verifyAccountsLandingScreen();
	...
	//   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	//   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"SameBank-MonthlySheduledTransfer-Occurences");
	...
	it("QuarterlySheduledTransfer-DateRange", async function() {
	  ...
	  await SelectDateRange();
	  await EnterNoteValue("QuarterlySheduleTranDateRange");
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	  await verifyAccountsLandingScreen();
	...
	//   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	//   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"SameBank-QuarterlySheduledTransfer-DateRange");
	...
	it("WeeklySheduledTransfer-DateRange", async function() {
	  ...
	  await SelectDateRange();
	  await EnterNoteValue("WeeklySheduledTransferDate");
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	  await verifyAccountsLandingScreen();
	  ...
	  //   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	  //   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"SameBank-WeeklySheduledTransfer-DateRange");
	...
	it("WeeklySheduledTransfer-Occurences", async function() {
	  ...
	  await SelectFrequency("Weekly");
	  await SelectOccurences("2");
	  await EnterNoteValue("WeeklySheduledTransferOccur");
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	  await verifyAccountsLandingScreen();
	...
	//   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	//   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"SameBank-WeeklySheduledTransfer-Occurences");
	...
	it("YearlySheduledTransfer-DateRange", async function() {
	 ...
	 await SelectFromAccount(Transfers.sameBankAccount.fromAccount);
	  ...
	  await SelectDateRange();
	  await EnterNoteValue("YearlyScheduleTrnDateRange");
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	  await verifyAccountsLandingScreen();
	...
	//   kony.automation.flexcontainer.click(["frmFastTransfers","flxContainer4"]);
	//   kony.automation.listbox.selectItem(["frmFastTransfers","lbxFrequency"], "Yearly");
	//   kony.automation.calendar.selectDate(["frmFastTransfers","calSendOnNew"], [10,25,2021]);
	//   kony.automation.calendar.selectDate(["frmFastTransfers","calEndingOnNew"], [11,25,2021]);
	  
	//   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	//   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"SameBank-YearlySheduledTransfer-DateRange");
	...
	it("YearlySheduledTransfer-Occurences", async function() {
	  ...
	  await SelectFrequency("Yearly");
	  await SelectOccurences("2");
	  await EnterNoteValue("Yearly SheduledTransferOccr");
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	  await verifyAccountsLandingScreen();
	...
	//   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	//   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"SameBank-Yearly SheduledTransfer-Occurences");
