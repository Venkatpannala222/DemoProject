describe("AccountsRB", function() {
	...
	it("CreditCardAcc_ContextMenuOptions", async function() {
	  
	//   var myList_Expected = new Array();
	//   myList_Expected.push(Accounts.creditcardAcc.ContextMenuOptions[0].type,Accounts.creditcardAcc.ContextMenuOptions[1].type,Accounts.creditcardAcc.ContextMenuOptions[2].type);
	...
	//   var myList = new Array();
	//   var myList_Expected = new Array();
	//   myList_Expected.push("Pay Bill","View Statements","Account Alerts");
	//   for(var x = 0; x <segLength-1; x++) {
	...
	it("LoanAcc_ContextMenuOptions", async function() {
	  ...
	  await clickOnLoanAccountContextMenu();
	  await verifyContextMenuOpts();
	  await MoveBackToLandingScreen_Accounts();
	...
	it("SavingAcc_ContextMenuOptions", async function() {
	  ...
	  await verifySavingsContextMenuOptions();
	  await MoveBackToLandingScreen_Accounts();
	...
	it("Validate Remove as Favorite Option", async function() {
	  //write your automation code here
	  await ValidateRemoveAsFavourite();
	  await MoveBackToLandingScreen_Accounts();
	...
	it("Validate Upcoming Transaction", async function() {
	  //write your automation code here
	  await VerifyUpcomingTransaction();
	  await MoveBackToLandingScreen_Accounts();
	  
	  
	},500000);
	
	it("Verify Account Dashboard", async function() {
	  //write your automation code here
	...
	it("VerifyCheckingAcc_ContextualMenu_Transfer", async function() {
	  ...
	  await EnterNoteValue("CheckAccConMenuTrans");
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	  await verifyAccountsLandingScreen();
	...
	it("VerifyCreditCardAccountonDashBoard", async function() {
	
	  await VerifyCreditCardAccountonDashBoard();
	  
	//   await kony.automation.playback.waitFor(["frmDashboard","lblShowing"]);
	//   expect(kony.automation.widget.getWidgetProperty(["frmDashboard","lblShowing"], "text")).toContain("Show");
	
	//   await kony.automation.playback.waitFor(["frmDashboard","accountList","segAccounts"]);
	//   await kony.automation.playback.waitFor(["frmDashboard","accountList","segAccounts[2,0]","lblAccountName"]);
	...
	it("VerifyDepositAcc_AdvanceSearch", async function() {
	  ...
	  await clickOnFirstDepositAccount();
	  await verifyAdvancedSearch_DepositAccount("1","1000");
	  await MoveBackToLandingScreen_AccDetails();
	...
	it("VerifyLoanAcc_AdvanceSearch", async function() {
	  ...
	  await clickOnFirstLoanAccount();
	  await verifyAdvancedSearch_LoanAccount("1","1000");
	  await MoveBackToLandingScreen_AccDetails();
