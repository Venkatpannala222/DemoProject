describe("TransferToOwnAcc", function() {
	...
	it("HalfYearlySheduledTransfer-DateRange", async function() {
	  ...
	  await SelectDateRange();
	  await EnterNoteValue("OwnAcc-HalfYearly-DateRange");
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	  await verifyAccountsLandingScreen();
	...
	//   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	//   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"OwnAcc-HalfYearlySheduledTransfer-DateRange");
	...
	it("HalfYearlySheduledTransfer-Occurences", async function() {
	  ...
	  await SelectFrequency("HalfYearly");
	  await SelectOccurences("2");
	  await EnterNoteValue("OwnAcc-HalfYearly-Occurences");
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	  await verifyAccountsLandingScreen();
	...
	//   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	//   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"OwnAcc-Half Yearly SheduledTransfer-Occurences");
	...
	it("MonthlySheduledTransfer-DateRange", async function() {
	  ...
	  await SelectDateRange();
	  await EnterNoteValue("OwnAcc-Monthly-DateRange");
	  await VerifyTransferConfirmationscreen_ReccurringTransfer(frequency,Range);
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	  await verifyAccountsLandingScreen();
	...
	//   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	//   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"OwnAcc-MonthlySheduledTransfer-DateRange");
	...
	it("MonthlySheduledTransfer-Occurences", async function() {
	  ...
	  await SelectFrequency("Monthly");
	  await SelectOccurences("2");
	  await EnterNoteValue("OwnAcc-Monthly-Occurences");
	  await VerifyTransferConfirmationscreen_ReccurringTransfer(frequency,Range);
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	  await verifyAccountsLandingScreen();
	...
	//   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	//   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"OwnAcc-MonthlySheduledTransfer-Occurences");
	...
	it("QuarterlySheduledTransfer-Occurences", async function() {
	 ...
	 await SelectFromAccount(Transfers.ownAccount.fromAccount);
	  ...
	  await SelectFrequency("Quarterly");
	  await SelectOccurences("2");
	  await EnterNoteValue("Ownacc-Quarterly-Occurences");
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	  await verifyAccountsLandingScreen();
	...
	//   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	//   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"OwnAcc-QuarterlySheduledTransfer-Occurences");
	...
	it("WeeklySheduledTransfer-Occurences", async function() {
	  ...
	  await SelectFrequency("Weekly");
	  await SelectOccurences("2");
	  await EnterNoteValue("Ownacc-WeeklyOccurences");
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	 await verifyAccountsLandingScreen();
	...
	//   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	//   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"OwnAcc-WeeklySheduledTransfer-Occurences");
	...
	it("YearlySheduledTransfer-DateRange", async function() {
	  ...
	  await SelectDateRange();
	  await EnterNoteValue("OwnAcc-Yearly-DateRange");
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	  await verifyAccountsLandingScreen();
	...
	//   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	//   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"OwnAcc-YearlySheduledTransfer-DateRange");
	...
	it("YearlySheduledTransfer-Occurences", async function() {
	  ...
	  await SelectFrequency("Yearly");
	  await SelectOccurences("2");
	  await EnterNoteValue("OwnAcc-Yearly-Occurences");
	  await ConfirmTransfer();
	  await VerifyTransferSuccessMessage();
	  await verifyAccountsLandingScreen();
	...
	//   await kony.automation.playback.waitFor(["frmFastTransfers","txtNotes"]);
	//   kony.automation.textbox.enterText(["frmFastTransfers","txtNotes"],"OwnAcc-Yearly SheduledTransfer-Occurences");
